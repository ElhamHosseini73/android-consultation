            ...
            public void onResponse(Call<AboutMessage> call, Response<AboutMessage> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    if (response.body().status.equals("1")) {
                        ...
                        if (response.body().about.contactInfo.size() > 0) {
                            binding.tvPhoneNumber1.setText(response.body().about.contactInfo.get(0).val);
                        }
                        if (response.body().about.contactInfo.size() > 1) {
                            binding.tvPhoneNumber2.setText(response.body().about.contactInfo.get(1).val);
                        }
